...
class ThrFiringRemainderAlgorithm final {
   public:
    explicit ThrFiringRemainderAlgorithm(const ThrFiringRemainderConfig& config);
    void setConfig(const ThrFiringRemainderConfig& config);
    void reInitialize();
    ThrusterOnTimeCmd update(ThrusterForceCmd thrusterForceCmd);

   private:
    ThrFiringRemainderConfig cfg;
